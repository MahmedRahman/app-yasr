...
class Result {
    ...
    factory Result.fromJson(Map<String, dynamic> json) => Result(
        allNotifications: List<AllNotification>.from(json["all_notifications"].map((x) => AllNotification.fromJson(x))),
    );

    Map<String, dynamic> toJson() => {
        "all_notifications": List<dynamic>.from(allNotifications.map((x) => x.toJson())),
    };
}
