...
RequestedModel requestedModelFromJson(String str) => RequestedModel.fromJson(json.decode(str));

String requestedModelToJson(RequestedModel data) => json.encode(data.toJson());
